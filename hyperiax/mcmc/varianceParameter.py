...
def uniform_logpdf(x, a, b):
    ...
    #print(b)
    #print(x)
    #print(uniform.logpdf(x, loc=a, scale=b-a))
...
class VarianceParameter(Parameter):
    ...
    # def propose(self, key):  #  Stefans code
    ...
    # def propose(self, key): # Sofias code
    #     '''
    #     Mirrored Gaussian proposal distrbution (symmetric, does not require probability evaluation in acceptance step)
    #     '''
    #     if self.keep_constant:
    #         return self
    ...
    #     # return uniform_logpdf(self.value, self.alpha, self.beta).sum()
    def log_prior(self):
        """ Logarithm of the prior probability of the parameter
        :return: The logarithm of the prior probability of the parameter
        """
